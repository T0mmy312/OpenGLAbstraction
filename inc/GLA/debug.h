 ...
 * 
 * @note For performance reasons gla::glCheckError is only called when DEBUG_BUILD is defined.
 ...
 */
    ...
    #define GL_CALL(x) do { x; gla::glCheckError(#x, __FILE__, __LINE__); } while(0)
