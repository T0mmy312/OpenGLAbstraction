...
public:
     ...
     * 
     * @note Possible errors when assigning can be found under egl::Program::setUniform.
     * @note Possible errors on explicit type conversion can be found under egl::Program::getUniform.
     *  
     * @warning Setting a uniform binds the program.
     * 
     * @param location The uniform location returned by getUniformLocation()
